...
export default function LoginForm() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    await LoginCall(email, password); // or formData.email, formData.password
  };
    ...
    <div className="w-90 max-w-md bg-white rounded-xl shadow-sm p-8">
      ...
      <form className="space-y-4">
        <div className="space-y-1">
          ...
          <Input id="email" type="email" className="w-full border-gray-300" name='email' value={email} onChange={handleChange} />
        </div>
      ...
      <div className="mt-6 flex flex-col gap-3">
        <button className="flex items-center justify-center gap-2 w-full p-2 border border-gray-300 rounded-md hover:bg-gray-50">
